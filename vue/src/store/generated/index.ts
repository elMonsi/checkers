...
import ElMonsiCheckersElmonsiCheckersCheckers from './elMonsi/checkers/elmonsi.checkers.checkers'
...
export default { 
  ...
  ElMonsiCheckersElmonsiCheckersCheckers: load(ElMonsiCheckersElmonsiCheckersCheckers, 'elmonsi.checkers.checkers'),
